...
public class HttpUtils {
    ...
    private static class RegListener {
    }
...
//媒体类型
    ...
    public class ModelImpel implements IModel{
        ...
        @Override
        public void getLoginDatas(String url, Map<String, String> map, LoginListener loginListener) {
        ...
        @Override
        public void getRegDatas(String url, Map<String, String> map, RegListener regListener) {
